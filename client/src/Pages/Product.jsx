...
const Product = () => {
  ...
  return productData ? (
    <div className=" border-t-2 pt-10 transition-opacity each-in duration-500 opacity-100">
      {/* product Data */}
            ...
            <div className=" flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  className={`border py-2 px-4 bg-gray-100 cursor-pointer border-gray-200 ${
