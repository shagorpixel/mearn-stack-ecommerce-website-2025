        ...
        <div className=' border-t border-gray-100'>
            ...
            <div className=' flex justify-between flex-col md:flex-row gap-3'>
                ...
                {getCartCount()?
                            ...
                            <div className=' flex items-start gap-6'>
                                ...
                                <div>
                                    ...
                                    <div className=' flex items-center gap-5 mt-2'>
                                        ...
                                        <p className=' px-2 sm:px-3 sm:py-1 border border-gray-100 saturate-50'>{item.size}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    :
                    <p className=' text-xl text-center lg:text-3xl  rounded-2xl bg-gray-50 py-8 w-full'>no product available on your cart </p>
                }
            </div>
